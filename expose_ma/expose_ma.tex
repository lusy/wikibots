...
Algorithmic governance mechanisms are exemplary analysed for two cases: the "flagged revisions" software extension and xqbot.
\newline
\newline
...
\begin{itemize}
    ...
    \item of the bots for which the source code is available: take exemplary cases particularly active in the community sphere, and study their social context: what community norms do they try to implement? what discussions happened prior to implementing the bots?
    \begin{itemize}
...
In that sense, I will try to do my best in weighing up every single case and deciding responsibly how and whether it should be disclosed at all.
